...
import airbg from '../../shared/assets/airbg.svg';
...
export default function AirportTransfer() {
  ...
  return (
    <>
      ...
      <div
        className="w-full bg-cover bg-center h-[400px]"
        style={{ backgroundImage: `url(${airbg})` }}
      >
        <div className="max-w-[1600px] mx-auto flex flex-col items-center justify-center text-center text-white h-full">
          <h2 className="text-3xl mt-[-80px] ml-[-110px] uppercase tracking-wide">Airport Transfers</h2>
          <h1 className="text-7xl font-bold uppercase">Hurghada</h1>
        </div>
      </div>
      ...
      <div className="max-w-[1600px] mx-auto px-5">
        <div className="flex space-x-2 mt-8">
          <Link to="/" className="hover:underline" onClick={scrollToTop}>Main Page</Link>
          <span className="text-white">|</span>
          <Link to="/airporttransfer" className="hover:underline" onClick={scrollToTop}>Airport Transfers</Link>
        </div>

        {/* Booking Section and FAQ/Text aligned side by side */}
        <div className="flex flex-col lg:flex-row mt-8 gap-10">
          {/* Booking Section */}
          <div className="flex-1 bg-white shadow-lg rounded-lg p-6">
            <h1 className="text-3xl font-bold text-black text-center mb-6 uppercase">Book Your Transfer</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative flex items-center">
                  ...
                  <div className="flex-1">
                    <label className="text-black font-semibold uppercase"> Date</label>
                    <input
                      type="date"
                      className="w-full bg-gray-100 border border-gray-300 rounded-lg py-3 pl-12 focus:ring-2 focus:ring-black focus:outline-none"
                    />
                ...
                <div className="relative flex items-center">
                  ...
                  <div className="flex-1">
                    <label className="text-black font-semibold uppercase"> Time</label>
                    <input
                      type="time"
                      className="w-full bg-gray-100 border border-gray-300 rounded-lg py-3 pl-12 focus:ring-2 focus:ring-black focus:outline-none"
                    />
            ...
            {orderPlaced && (
              <div className="fixed top-10 left-1/2 transform -translate-x-1/2 bg-green-100 border text-black px-6 py-3 rounded-lg shadow-lg">
                Your order has been successfully placed! We'll take care of everything for you.
              </div>
            )}
          </div> 
										<div className="w-full lg:w-[35%] mt-10 ml-6 mb-7">
							<div>
